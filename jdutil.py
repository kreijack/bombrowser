...
def test():
    assert(datetime(1850,1,1).to_jd() == 2396758.5)
    assert(datetime(1950,1,1).to_jd() == 2433282.5)
    assert(datetime(1990,1,1).to_jd() == 2447892.5)
    assert(datetime(2000,1,1).to_jd() == 2451544.5)
    assert(datetime(2000,6,1).to_jd() == 2451696.5)
    assert(datetime(2000,8,27).to_jd() == 2451783.5)
    assert(datetime(2010,1,1).to_jd() == 2455197.5)
    assert(datetime(2020,1,1).to_jd() == 2458849.5)
    assert(datetime(2020,3,1).to_jd() == 2458909.5)
    assert(datetime(2050,1,1).to_jd() == 2469807.5)
    assert(datetime(2100,1,1).to_jd() == 2488069.5)
